...
al termine di ogni \textit{milestone} veniva effettuato il \textit{testing} tramite l'esecuzione del
...
\begin{center}
    ...
    \reqval{R40-Q-D}{L'algoritmo finale scelto deve generare dei \textit{log} di chiamata per manutenzioni future}{-}{Soddisfatto}
