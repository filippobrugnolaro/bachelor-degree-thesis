...
\noindent Come descritto nei capitoli precedenti, il prodotto finale consiste in una \textit{Windows form} che
...
\textit{Tabu search} viene creata una nuova soluzione che viene visualizzata in una lista
...
mi ha portato a effettuare molte domande al \textit{tutor} durante lo \textit{stage}.
