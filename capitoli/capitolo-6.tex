...
in gran parte parte per il \textit{testing} (vedasi problema del \textit{\gls{databaseg}} nella
...
la condizione necessaria per il superamento dell'attività di \textit{stage}.\\
...
Inoltre, aver imparato in precedenza come modellare e risolvere un problema di ottimizzazione tramite tecniche di \gls{ricercaoperativag}
...
di \gls{ricercaoperativag} ben conosciute.\\
