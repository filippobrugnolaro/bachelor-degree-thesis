...
\begin{itemize}
	...
	\item \textbf{Scenario principale: }
		\begin{enumerate}
			...
			In particolare per ogni ordine ne visualizza:
		\end{enumerate}
...
\noindent \textbf{\large UC 5.8 - Filtraggio per prezzo parziale del singolo ordine}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale: }
		\begin{enumerate}
			\item L'utente filtra uno o più ordini per prezzo parziale del singolo ordine.
		\end{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Generalizzazioni: }
        \begin{itemize}
            ...
            \item Ordinamento per data previsione fine copertura;
            \item Ordinamento per quantità ordinata;
            \item Ordinamento per prezzo parziale del singolo ordine.
        \end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale: }
		\begin{enumerate}
			\item L'utente ordina gli elementi rispetto al prezzo parziale del singolo ordine.
		\end{enumerate}
		

	\item \textbf{Postcondizione: }\\[0.3cm]
		L'utente visualizza correttamente tutti gli elementi rispetto al prezzo parziale del singolo ordine.
...
\req{R36-F-O}{L'utente deve poter ordinare la lista in rispetto al prezzo parziale}{\hyperref[uc:ordinamento-prezzo-parziale-ord]{UC6.7}}
\end{longtable}
\end{center}%
