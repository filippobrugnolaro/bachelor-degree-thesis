...
\noindent \intro{In questo capitolo viene esposta l'analisi dei requisiti effettuata durante lo \textit{stage}, nella quale vengono descritte le funzionalità tramite i casi d'uso.}\\
...
\begin{itemize}
	...
	\item \textbf{Scenario principale: }
		\begin{enumerate}
			\item L'utente richiede la visualizzazione del totale non ottimizzato (\hyperref[uc:visualizzazione-totale-non-ottimizzato]{UC 3.1});
			\item L'utente richiede la visualizzazione del totale ottimizzato (\hyperref[uc:visualizzazione-totale-ottimizzato]{UC 3.2});
			\item L'utente richiede la visualizzazione dello scostamento percentuale dei totali (\hyperref[uc:visualizzazione-scostamento-percentuale-totali]{UC 3.3}).
		\end{enumerate}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale: }
		\begin{enumerate}
			\item L'utente richiede la visualizzazione del totale non ottimizzato.
		\end{enumerate}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale: }
		\begin{enumerate}
			\item L'utente richiede la visualizzazione del totale ottimizzato.
		\end{enumerate}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale: }
		\begin{enumerate}
			\item L'utente richiede la visualizzazione dello scostamento percentuale dei totali.
		\end{enumerate}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale: }
		\begin{enumerate}
			\item L'utente richiede la visualizzazione della lista degli ordini da effettuare.
		\end{enumerate}
...
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.90\columnwidth]{usecase/UC 5.pdf} 
...
\req{R40-Q-D}{L'algoritmo finale scelto deve generare dei \mbox{\textit{\gls{logg}} $^{[g]}$} di chiamata per manutenzioni future}{-}
