...
\begin{figure}[!h] 
 ...
 \end{figure}
\noindent \textit{C\#} \cite{site:csharp-docs} è un linguaggio di programmazione multi-paradigma orientato agli oggetti
...
\begin{figure}[!h] 
 ...
 \end{figure}
\noindent \textit{Visual Studio 2019} \cite{site:vs-docs} è un ambiente di sviluppo integrato (\gls{ideg}) fornito da \textit{Microsoft}.
...
\end{figure}
\noindent \textit{\gls{devexpressg}} \cite{site:devexpress-docs} è una compagnia che produce strumenti di sviluppo \textit{software} per
...
\end{figure}
\noindent \textit{IBM} \textit{Informix} \cite{site:informix-docs} è un prodotto di \textit{IBM}. La base di dati \textit{Informix} è usata in molte
...
\end{figure}
\noindent \textit{Git} \cite{site:wiki} è uno strumento per il controllo di versione distribuito del codice sorgente delle \textit{repository}.\\
