...
\begin{itemize}
    ...
    \item \textbf{Paper}: dichiarazioni o dati di esperimenti già effettuati \cite{site:paper-chen} \cite{site:paper-roli} \cite{site:paper-carlos}.
\end{itemize}
...
\noindent La \textit{Tabu search} \cite{site:dispense-de-giovanni} è un metodo, classificato come \textit{Trajectory Method} (\textit{Metodo a traiettoria}), basato su \gls{ricercalocaleg}
...
Di seguito vengono elencati i pro e i contro del seguente approccio \cite{site:paper-lo-go} \cite{site:articolo-tabu-search}.\\
\vspace*{\fill}
\newpage
\noindent \paragraph{Aspetti positivi}
\begin{itemize}
...
Di seguito vengono elencati i pro e i contro del seguente approccio \cite{site:articolo-alg-gen} \cite{site:paper-lo-go}.\\
