...
\begin{algorithm}[!h]
    \captionsetup{labelformat=empty}
    \caption{Pseudocodice string replacement - Algoritmo Genetico}
    \vspace{0.1cm}
    \hspace*{\algorithmicindent} \textbf{Input:} {$stringa\_corretta$}, {$crossover\_rate$}, {$mutation\_rate$}, \\\hspace*{54pt}{$max\_iterazioni$}\\
    \hspace*{\algorithmicindent} \textbf{Output:} {$sol_{best}, fitness_{best}$}
    \begin{algorithmic}[1]
