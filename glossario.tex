...
\newglossaryentry{erpg}
{
    ...
    text=ERP,
    sort=erp,
    description={Tipologia di software che integra tutti i processi di business rilevanti di un'azienda[2] e tutte le funzioni aziendali, ad esempio vendite, acquisti, gestione magazzino, finanza, contabilità\ddots}
}
