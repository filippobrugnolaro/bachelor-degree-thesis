...
\usepackage[backend=biber,style=numeric-comp,sorting=debug,hyperref,backref]{biblatex}
...
\input{capitoli/capitolo-2}             % Studio di fattibilità
\input{capitoli/capitolo-3}             % Concept Preview
\input{capitoli/capitolo-4}             % Product Prototype
\input{capitoli/capitolo-5}             % Product Design Freeze e SOP
